...
000005ad <main>:
 ...
 5fb:	8d 83 98 00 00 00    	lea    eax,[ebx+0x98]
 601:	8b 00                	mov    eax,DWORD PTR [eax]
 603:	01 c2                	add    edx,eax
 605:	8d 83 98 00 00 00    	lea    eax,[ebx+0x98]
 60b:	89 10                	mov    DWORD PTR [eax],edx
 60d:	83 45 dc 01          	add    DWORD PTR [ebp-0x24],0x1
 611:	83 7d dc 09          	cmp    DWORD PTR [ebp-0x24],0x9
 615:	7e d8                	jle    5ef <main+0x42>
 617:	83 ec 08             	sub    esp,0x8
 61a:	6a 00                	push   0x0
 61c:	8d 45 ec             	lea    eax,[ebp-0x14]
 61f:	50                   	push   eax
 620:	e8 0b fe ff ff       	call   430 <gettimeofday@plt>
 625:	83 c4 10             	add    esp,0x10
 628:	8b 55 ec             	mov    edx,DWORD PTR [ebp-0x14]
 62b:	8b 45 e4             	mov    eax,DWORD PTR [ebp-0x1c]
 62e:	29 c2                	sub    edx,eax
 630:	89 d0                	mov    eax,edx
 632:	69 d0 40 42 0f 00    	imul   edx,eax,0xf4240
 638:	8b 45 f0             	mov    eax,DWORD PTR [ebp-0x10]
 63b:	01 c2                	add    edx,eax
 63d:	8b 45 e8             	mov    eax,DWORD PTR [ebp-0x18]
 640:	29 c2                	sub    edx,eax
 642:	89 d0                	mov    eax,edx
 644:	89 45 e0             	mov    DWORD PTR [ebp-0x20],eax
 647:	83 ec 08             	sub    esp,0x8
 64a:	ff 75 e0             	push   DWORD PTR [ebp-0x20]
 64d:	8d 83 50 e7 ff ff    	lea    eax,[ebx-0x18b0]
 653:	50                   	push   eax
 654:	e8 c7 fd ff ff       	call   420 <printf@plt>
 659:	83 c4 10             	add    esp,0x10
 65c:	b8 00 00 00 00       	mov    eax,0x0
 661:	8b 4d f4             	mov    ecx,DWORD PTR [ebp-0xc]
 664:	65 33 0d 14 00 00 00 	xor    ecx,DWORD PTR gs:0x14
 66b:	74 05                	je     672 <main+0xc5>
 66d:	e8 7e 00 00 00       	call   6f0 <__stack_chk_fail_local>
 672:	8d 65 f8             	lea    esp,[ebp-0x8]
 675:	59                   	pop    ecx
 676:	5b                   	pop    ebx
 677:	5d                   	pop    ebp
 678:	8d 61 fc             	lea    esp,[ecx-0x4]
 67b:	c3                   	ret    
