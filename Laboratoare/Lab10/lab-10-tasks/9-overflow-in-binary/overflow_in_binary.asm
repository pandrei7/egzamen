...
080484fd <check_string>:
 ...
 8048503:	c7 45 f4 78 56 34 12 	mov    DWORD PTR [ebp-0xc],0x12345678   ; ebp-12 = 0x12345678
 804850a:	83 ec 08             	sub    esp,0x8
 804850d:	ff 75 08             	push   DWORD PTR [ebp+0x8]              ; pune param. pe stiva
 8048510:	8d 45 d4             	lea    eax,[ebp-0x2c]
 8048513:	50                   	push   eax                              ; pune pe stiva ebp-44
 8048514:	e8 57 fe ff ff       	call   8048370 <strcpy@plt>             ; copiaza din param in ebp-44
 ...
 8048526:	81 7d f4 50 52 30 4e 	cmp    DWORD PTR [ebp-0xc],0x4e305250   ; vreau ca la ebp-12 sa fie 0x4e305250
